...
export default function calcWords(props) {
    let {data, maxFontSize, minFontSize, streamSizeScale, screenDimensions, stackedLayers, dates, boxes, boxWidth, fields} = props;
    ...
    function place(word, board, bc){
        var maxDelta = ~~Math.sqrt((board.boxWidth*board.boxWidth) + (board.boxHeight*board.boxHeight)),
