...
function WordStream({
	...
	useEffect(() => {
		...
		if(prevBrushRange && prevBrushRange[0] === brushRange[0] && prevBrushRange[1] === brushRange[1]) return;
		...
		setClearBrush(false);
	}, [setSubGraphData, rawData, brushRange, setDisplayBarChart, prevBrushRange, setClearBrush]);
